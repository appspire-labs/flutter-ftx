...
class AlertX {
  ...
  showAlert({required String title, required String msg, String? negativeButtonText, required String positiveButtonText,void Function()? negativeButtonPressed,required void Function() positiveButtonPressed, required Color statusBarColor}){
      ...
      showDialog(
          ...
          builder:(BuildContext context){
            return AlertDialog(
              ...
              content: Text(msg,style: TextStyle(height: 1.5),),
              actions: [
